...
import {addProgram} from '../utils/addProgram.js' 
...
function main() {
  ...
  var reverseLightDirection = gl.getUniformLocation(program, 'u_reverseLightDirection');

  gl.uniform4fv(colorLocation, [.6, 0, .2, 1]);
  gl.uniform3fv(reverseLightDirection, m4.normalize([0.5, 0, -1]))
  ...
  // Create a buffer to put normal in
  ...
  function drawScene() {
    ...
    // Turn on the normalcolor attribute
...
// Fill the buffer with normal for the 'F'.
